# Contributing to EdgeWalker by Periphery

We would love for you to contribute to Edgewalker and help make it even better than it is today!
...
Instead, we recommend using [Github Discussions](https://github.com/periphery-security/edgewalker/discussions) to ask support-related questions.
...
You can file new issues by selecting from our [new issue templates](https://github.com/periphery-security/edgewalker/issues/new/choose) and filling out the issue template.
...
1. Search [GitHub](https://github.com/periphery-security/edgewalker/pulls) for an open or closed PR that relates to your submission.
...
2. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the [periphery-security/edgewalker](https://github.com/periphery-security/edgewalker/fork) repo.
...
6. Run the full Edgewalker test suite, as described in the [developer documentation][dev-doc], and ensure that all tests pass.
...
9. In GitHub, send a pull request to `edgewalker:main`.
...
2. Re-run the Edgewalker test suites to ensure tests are still passing.
...
- We follow [Ruff Style Guide][ruff-style-guide], but wrap all code at **80 characters**.
...
[dev-doc]: ./docs/contributing/building-and-testing-edgewalker.md
[commit-message-guidelines]: ./docs/contributing/commit-message-guidelines.md
[github]: https://github.com/periphery-security/edgewalker
[ruff-style-guide]: https://docs.astral.sh/ruff/rules/
